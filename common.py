...
def hex_to_base64(hex_str):
        converts a hex encoded string to an equivalent base64 encoded string
        args:
                hex_str: hex encoded string to re-encode to base64
        returns:
                re-encoded version of the string in base64
...
def base64_to_hex(b64_str):
        ...
        return base64.b64decode(b64_str).encode("hex")
'''
